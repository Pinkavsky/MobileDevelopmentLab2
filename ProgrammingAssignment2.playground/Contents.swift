...
class TimeBP {
    ...
    func sumBP(obj: TimeBP) -> TimeBP? {
        ...
        return TimeBP(hours: sumOfHours, minutes: sumOfMinutes, seconds: sumOfSeconds)
    }
    
    func differenceBP(obj: TimeBP) -> TimeBP? {
        ...
        return TimeBP(hours: newSeconds / 60 / 60, minutes: newSeconds / 60 % 60, seconds: newSeconds % 60)
    }
    
    static func sumTwoObjectsBP(obj1: TimeBP, obj2: TimeBP) -> TimeBP? {
    ...
    static func differenceTwoObjectsBP(obj1: TimeBP, obj2: TimeBP) -> TimeBP? {
...
var timeObj1: TimeBP = TimeBP()
print(timeObj1.description())
// failable-initializator with hours:minutes:seconds
var timeObj2: TimeBP = TimeBP(hours: 19, minutes: 34, seconds: 56)!
print(timeObj2.description())
var timeObj3: TimeBP = TimeBP(hours: 23, minutes: 2, seconds: 6)!
print(timeObj3.description())
// sum of self object and incoming object
var timeObj4: TimeBP = timeObj2.sumBP(obj: timeObj3)!
print(timeObj4.description())
// difference of self object and incoming object
var timeObj5: TimeBP = timeObj3.differenceBP(obj: timeObj4)!
print(timeObj5.description())
// static func, sum of two different objects
var timeObj6: TimeBP = TimeBP.sumTwoObjectsBP(obj1: timeObj2, obj2: timeObj3)!
print(timeObj6.description())
// static func, difference of two different objects
var timeObj7: TimeBP = TimeBP.differenceTwoObjectsBP(obj1: timeObj3, obj2: timeObj4)!
